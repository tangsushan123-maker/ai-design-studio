...
- Node cards, result cards, result history, and image manager metadata have had their smallest labels normalized upward; project/archive secondary panels still need one typography pass.
