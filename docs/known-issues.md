...
- Node cards have had their smallest status and handle labels normalized upward; secondary project/archive panels still contain mixed `text-[9px] / text-[10px] / text-[11px]` sizing and need one more pass.
