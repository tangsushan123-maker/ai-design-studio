...
export function writeProjectSnapshot(projectId: string, payload: ProjectPayload, reason: ProjectSnapshot["reason"]) {
...
export function persistProjectPayloadForLifecycleExit(payloadText: string) {
